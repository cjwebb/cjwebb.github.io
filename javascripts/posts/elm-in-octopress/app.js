...
Elm.Stamps.make = function (_elm) {
   ...
   var scene = F2(function (_p0,locs) {
      ...
      var drawPentagon = function (_p2) {
         ...
         {ctor: "_Tuple2"
         ,_0: $Basics.toFloat(_p4) - $Basics.toFloat(_p6) / 2
         ,_1: $Basics.toFloat(_p5) / 2 - $Basics.toFloat(_p3._1)},
         A2($Graphics$Collage.filled,
         A4($Color.hsla,$Basics.toFloat(_p4),0.9,0.6,0.7),
         A2($Graphics$Collage.ngon,5,20))));
      };
      return $Graphics$Element.layers(_U.list([A3($Graphics$Collage.collage,
                                              _p6,
                                              _p5,
                                              A2($List.map,drawPentagon,locs))
   ...
   $Window.dimensions,
   clickLocations);
   return _elm.Stamps.values = {_op: _op
                               ,main: main
